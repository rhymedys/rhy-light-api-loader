 ...
 * @Last Modified time: 2019-07-18 14:34:10
 */
...
module.exports = function (source, map, meta) {
  ...
  const lastFileNameStartPos = this.resourcePath.lastIndexOf('\\') + 1 || this.resourcePath.lastIndexOf('\/') +1
  if (this.resourcePath && this.resourcePath.substring(lastFileNameStartPos, this.resourcePath.lastIndexOf('.')).toLowerCase() === fileName) {
